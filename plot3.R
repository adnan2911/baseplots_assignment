...
#Plot3
png("plot3.png",width=480,height=480, units ="px", pointsize = 15)
...
legend("topright", legend=c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"),col=c("black","red", "blue"),cex=0.85,lwd=0.4)
dev.off()